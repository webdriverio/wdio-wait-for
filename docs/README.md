...
- [textToBePresentInElement](docs/modules/element_elementcontainstext.md)
- [textToBePresentInElementValue](docs/modules/element_elementcontainsvalue.md)
...
- [invisibilityOf](docs/modules/element_elementtobeinvisible.md)
- [visibilityOf](docs/modules/element_elementtobevisible.md)
